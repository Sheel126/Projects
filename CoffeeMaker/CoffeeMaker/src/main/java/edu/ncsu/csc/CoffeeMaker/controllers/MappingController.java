...
public class MappingController {
    ...
    public String addRecipePageAlternative ( final Model model ) {
        return "addrecipe";
    }
    ...
    /**
     * Handles a GET request for Milestone 5 test page. The GET request provides
     * a view to the client that includes the list of the current ingredients in
     * the inventory and a form where the client can enter more ingredients to
    ...
    public String testForm ( final Model model ) {
        return "test";
    }
