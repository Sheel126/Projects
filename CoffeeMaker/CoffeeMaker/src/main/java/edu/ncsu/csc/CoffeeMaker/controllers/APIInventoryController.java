...
public class APIInventoryController extends APIController {
    ...
    public ResponseEntity updateInventory ( @RequestBody final Inventory inventory ) {
        ...
        final List<Ingredient> currentList = inventory.getIngredients();
        for ( final Ingredient existingIngredient : currentList ) {
            inventoryCurrent.addIngredients( existingIngredient );
        }
