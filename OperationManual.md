...
5. **swing_scanner.py** — Scans for valid swing trade setups based on technical filters (EMA, RSI, ATR, MACD)
6. **trade_planner.py** — Generates detailed trade plans for filtered setups, including stock entry/stop/targets and LEAPS options recommendations
